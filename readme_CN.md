...
后续更新版本只需执行`sh restart-torna.sh 版本号`, 如:`sh restart-torna.sh 1.34.0`
...
`docker pull registry.cn-hangzhou.aliyuncs.com/tanghc/torna:1.34.0`
...
docker run --name torna --restart=always \
  ...
  -d registry.cn-hangzhou.aliyuncs.com/tanghc/torna:1.34.0
```
